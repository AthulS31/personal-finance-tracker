            ...
            {transactions?.map(transaction => (
              ...
              >
                ...
                <div className="flex space-x-3">
                  <Link to={`/user/transaction/update-transaction/${transaction._id}`}>
...
//   // Delete handler: calls the API and refetches the transaction list upon success
//   const handleDelete = (id) => {
...
//   // Update handler: navigates to the update transaction page
//   const handleUpdateTransaction = (id) => {
//     navigate(`/user/transaction/update/${id}`);
//   };
